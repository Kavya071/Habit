  ...
  const difficulties = [
    {
      ...
      platformFee: 3,
      description: 'Start digital detox',
      color: '#4CAF50',
      icon: '🏃'
    },
    {
      ...
      platformFee: 5,
      description: 'Control screen time',
      color: '#FF6B35',
      icon: '🏃‍♂️'
    },
    {
      ...
      proofRequired: 'Daily proof',
      platformFee: 5,
      description: 'Break phone addiction',
      color: '#FF6B35',
      icon: '🏃‍♀️'
    }
  ];
      ...
      <div className="running-challenge-tracker">
        <div className="challenge-sponsored-header">
          <div className="sponsor-banner">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Digital Wellbeing.svg" alt="Digital Wellbeing" className="sponsor-logo" style={{maxHeight: '40px'}} />
            <span className="sponsor-tag">SPONSORED BY Digital Wellbeing</span>
          </div>
          
          <div className="challenge-header-info">
            <h1>🏃 Social Media Detox Challenge</h1>
            <p>{activeChallenge.duration} Days • Reduce Screen Time</p>
        ...
        <div className="sponsor-promo-card">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Digital Wellbeing.svg" alt="Digital Wellbeing" className="promo-logo" style={{maxHeight: '50px'}} />
          <div className="promo-content">
            <h3>🎁 Complete & Win Digital Wellbeing Gear!</h3>
            <p>Finish this challenge and get special discount codes + chance to win Digital Wellbeing running shoes worth ₹5,000!</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="modal-body">
                  <div className="upload-instructions">
                    ...
                    <span className="tip-text">💡 Tip: Use Digital Wellbeing Run Club or Strava app!</span>
                  </div>
    ...
    <div className="running-challenge-page">
      <div className="challenge-hero">
        <div className="hero-sponsor-badge">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Digital Wellbeing.svg" alt="Digital Wellbeing" style={{maxHeight: '28px'}} />
          <span>POWERED BY Digital Wellbeing</span>
        </div>
        ...
        >
          ...
          <h1>Social Media Detox Challenge</h1>
          <p className="hero-subtitle">Reduce Screen Time • Build Endurance</p>
