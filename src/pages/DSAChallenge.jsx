  ...
  const difficulties = [
    {
      ...
      platformFee: 3,
      description: 'Start solving DSA problems',
      color: '#4CAF50',
      icon: '🏃'
    },
    {
      ...
      <div className="running-challenge-tracker">
        <div className="challenge-sponsored-header">
          <div className="sponsor-banner">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_LeetCode.svg" alt="LeetCode" className="sponsor-logo" style={{maxHeight: '40px'}} />
            <span className="sponsor-tag">SPONSORED BY LeetCode</span>
          </div>
          
          <div className="challenge-header-info">
            <h1>🏃 DSA Challenge</h1>
            <p>{activeChallenge.duration} Days • Solve 1 DSA Problem Daily</p>
        ...
        <div className="sponsor-promo-card">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_LeetCode.svg" alt="LeetCode" className="promo-logo" style={{maxHeight: '50px'}} />
          <div className="promo-content">
            <h3>🎁 Complete & Win LeetCode Gear!</h3>
            <p>Finish this challenge and get special discount codes + chance to win LeetCode running shoes worth ₹5,000!</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="modal-body">
                  <div className="upload-instructions">
                    ...
                    <span className="tip-text">💡 Tip: Use LeetCode Run Club or Strava app!</span>
                  </div>
    ...
    <div className="running-challenge-page">
      <div className="challenge-hero">
        <div className="hero-sponsor-badge">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_LeetCode.svg" alt="LeetCode" style={{maxHeight: '28px'}} />
        ...
        >
          ...
          <h1>DSA Challenge</h1>
          <p className="hero-subtitle">Solve 1 DSA Problem Daily • Build Endurance</p>
