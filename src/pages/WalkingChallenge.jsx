  ...
  const difficulties = [
    {
      ...
      platformFee: 3,
      description: 'Start walking daily',
      color: '#4CAF50',
      icon: '🏃'
    },
    {
      ...
      platformFee: 5,
      description: 'Build walking habit',
      color: '#FF6B35',
      icon: '🏃‍♂️'
    },
    {
      ...
      <div className="running-challenge-tracker">
        <div className="challenge-sponsored-header">
          <div className="sponsor-banner">
            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Decathlon_Logo.svg/2560px-Decathlon_Logo.svg.png" alt="Decathlon" className="sponsor-logo" style={{maxHeight: '40px'}} />
            <span className="sponsor-tag">SPONSORED BY Decathlon</span>
          </div>
          
          <div className="challenge-header-info">
            <h1>🏃 Walking Challenge</h1>
            <p>{activeChallenge.duration} Days • Walk 10,000 Steps Daily</p>
        ...
        <div className="sponsor-promo-card">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Decathlon_Logo.svg/2560px-Decathlon_Logo.svg.png" alt="Decathlon" className="promo-logo" style={{maxHeight: '50px'}} />
          <div className="promo-content">
            <h3>🎁 Complete & Win Decathlon Gear!</h3>
            <p>Finish this challenge and get special discount codes + chance to win Decathlon sports gear worth ₹5,000!</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="modal-body">
                  <div className="upload-instructions">
                    ...
                    <span className="tip-text">💡 Tip: Use Decathlon Run Club or Strava app!</span>
                  </div>
    ...
    <div className="running-challenge-page">
      <div className="challenge-hero">
        <div className="hero-sponsor-badge">
          <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/08/Decathlon_Logo.svg/2560px-Decathlon_Logo.svg.png" alt="Decathlon" style={{maxHeight: '28px'}} />
          <span>POWERED BY Decathlon</span>
        </div>
        ...
        >
          ...
          <h1>Walking Challenge</h1>
          <p className="hero-subtitle">Walk 10,000 Steps Daily • Build Endurance</p>
