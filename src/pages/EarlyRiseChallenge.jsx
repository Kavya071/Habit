  ...
  const difficulties = [
    {
      ...
      platformFee: 3,
      description: 'Start waking early',
      color: '#4CAF50',
      icon: '🏃'
    },
    {
    ...
    },
    {
      ...
      proofRequired: 'Daily proof',
      platformFee: 5,
      description: 'Master early rising',
      color: '#FF6B35',
      icon: '🏃‍♀️'
    }
  ];
      ...
      <div className="running-challenge-tracker">
        <div className="challenge-sponsored-header">
          <div className="sponsor-banner">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Headspace.svg" alt="Headspace" className="sponsor-logo" style={{maxHeight: '40px'}} />
            <span className="sponsor-tag">SPONSORED BY Headspace</span>
          </div>
          
          <div className="challenge-header-info">
            <h1>🏃 Early Morning Challenge</h1>
            <p>{activeChallenge.duration} Days • Wake Up at 6 AM</p>
        ...
        <div className="sponsor-promo-card">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Headspace.svg" alt="Headspace" className="promo-logo" style={{maxHeight: '50px'}} />
          <div className="promo-content">
            <h3>🎁 Complete & Win Headspace Gear!</h3>
            <p>Finish this challenge and get special discount codes + chance to win Headspace running shoes worth ₹5,000!</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="modal-body">
                  <div className="upload-instructions">
                    ...
                    <span className="tip-text">💡 Tip: Use Headspace Run Club or Strava app!</span>
                  </div>
    ...
    <div className="running-challenge-page">
      <div className="challenge-hero">
        <div className="hero-sponsor-badge">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_Headspace.svg" alt="Headspace" style={{maxHeight: '28px'}} />
          <span>POWERED BY Headspace</span>
        </div>
        ...
        >
          ...
          <h1>Early Morning Challenge</h1>
          <p className="hero-subtitle">Wake Up at 6 AM • Build Endurance</p>
