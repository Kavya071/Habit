  ...
  const difficulties = [
    {
      ...
      platformFee: 3,
      description: 'Start SQL practice',
      color: '#4CAF50',
      icon: '🏃'
    },
    {
    ...
    },
    {
      ...
      proofRequired: 'Daily proof',
      platformFee: 5,
      description: 'Database expert path',
      color: '#FF6B35',
      icon: '🏃‍♀️'
    }
  ];
      ...
      <div className="running-challenge-tracker">
        <div className="challenge-sponsored-header">
          <div className="sponsor-banner">
            <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_HackerRank.svg" alt="HackerRank" className="sponsor-logo" style={{maxHeight: '40px'}} />
            <span className="sponsor-tag">SPONSORED BY HackerRank</span>
          </div>
          
          <div className="challenge-header-info">
            <h1>🏃 SQL Challenge</h1>
            <p>{activeChallenge.duration} Days • Solve 1 SQL Query Daily</p>
        ...
        <div className="sponsor-promo-card">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_HackerRank.svg" alt="HackerRank" className="promo-logo" style={{maxHeight: '50px'}} />
          <div className="promo-content">
            <h3>🎁 Complete & Win HackerRank Gear!</h3>
            <p>Finish this challenge and get special discount codes + chance to win HackerRank running shoes worth ₹5,000!</p>
          </div>
        </div>
              ...
              >
                ...
                <div className="modal-body">
                  <div className="upload-instructions">
                    ...
                    <span className="tip-text">💡 Tip: Use HackerRank Run Club or Strava app!</span>
                  </div>
    ...
    <div className="running-challenge-page">
      <div className="challenge-hero">
        <div className="hero-sponsor-badge">
          <img src="https://upload.wikimedia.org/wikipedia/commons/a/a6/Logo_HackerRank.svg" alt="HackerRank" style={{maxHeight: '28px'}} />
          <span>POWERED BY HackerRank</span>
        </div>
        ...
        >
          ...
          <h1>SQL Challenge</h1>
          <p className="hero-subtitle">Solve 1 SQL Query Daily • Build Endurance</p>
